...
type api struct {
	...
	version string
	githash string
	logger  memorywriter.LogWriter
}

func ServeAPI(r *mux.Router, c core.CoreInf, v, h string, l memorywriter.LogWriter) {
	api := &api{
		core:    c,
		version: v,
		githash: h,
...
func (a *api) Listen(w http.ResponseWriter, r *http.Request) {
	...
	var entries []trezordcore.EnumerateEntry
...
func (a *api) Call(w http.ResponseWriter, r *http.Request) {
	a.call(w, r, trezordcore.CallModeReadWrite, false)
}

func (a *api) Post(w http.ResponseWriter, r *http.Request) {
	a.call(w, r, trezordcore.CallModeWrite, false)
}

func (a *api) Read(w http.ResponseWriter, r *http.Request) {
	a.call(w, r, trezordcore.CallModeRead, false)
}

func (a *api) CallDebug(w http.ResponseWriter, r *http.Request) {
	a.call(w, r, trezordcore.CallModeReadWrite, true)
}

func (a *api) PostDebug(w http.ResponseWriter, r *http.Request) {
	a.call(w, r, trezordcore.CallModeWrite, true)
}

func (a *api) ReadDebug(w http.ResponseWriter, r *http.Request) {
	a.call(w, r, trezordcore.CallModeRead, true)
}

func (a *api) call(w http.ResponseWriter, r *http.Request, mode trezordcore.CallMode, debug bool) {
	a.logger.Log("start")
	...
	var binbody []byte
	if mode != trezordcore.CallModeRead {
	...
	if mode != trezordcore.CallModeWrite {
